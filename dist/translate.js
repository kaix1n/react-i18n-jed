...
function translate(WrappedComponent) {
  ...
  function (_React$Component) {
    ...
    _createClass(Translate, [{
      ...
      value: function render() {
        ...
        return React.createElement(_I18nProvider.I18nContext.Consumer, null, function (i18n) {
  ...
  _defineProperty(Translate, "WrappedComponent", WrappedComponent);

  var ForwardedComponent = React.forwardRef(function (props, ref) {
    return React.createElement(Translate, _extends({}, props, {
      forwardedRef: ref
    }));
  });
  ForwardedComponent.displayName = "Translate(".concat(name, ")");
